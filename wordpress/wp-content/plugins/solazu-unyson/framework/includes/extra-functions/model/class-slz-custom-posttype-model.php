		...
		if(!empty($tabs)){
			...
			foreach($tabs as $k=>$v){
				...
				if($count == 5){
					...
					<a href="#" role="tab" class="dropdown-toggle more link" data-toggle="dropdown">'.esc_html__( 'More', 'slz' ).'&nbsp; <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu">';
				}
				$output .= '<li '.$active_cls.'  role="presentation"><a href="'.esc_attr($k).'" class="link" role="tab" data-toggle="tab">'.esc_attr($v).'</a></li>';
			}
