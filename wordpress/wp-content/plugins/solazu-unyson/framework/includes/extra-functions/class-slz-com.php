...
class SLZ_Com {
	...
	public static function get_palette_color(){
		...
		$theme_color_settings = slz_get_db_settings_option( 'color_settings', $theme_colors );

		return $theme_color_settings;
	}

	public static function get_palette_selected_color( $data ){
	 ...
	 * @param array $options
	 */
	public static function get_woo_account() {
		...
		if( $header_account != 'disable' &&  class_exists( 'WooCommerce' ) ){
			...
			if( $out_html ) {
				echo '<div class="dropdown woo-account-wrapper">
