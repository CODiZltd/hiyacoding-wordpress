...
<p>
	<label for="<?php echo  esc_attr( $object->get_field_id('template') ); ?>"><?php esc_html_e( 'Template', 'slz' );?></label>

	<select class="widefat" id="<?php echo esc_attr( $object->get_field_id( 'template' ) ); ?>" name="<?php echo esc_attr( $object->get_field_name('template') ); ?>" >
		<option value="grid"<?php if( $template == 'grid' ) { echo " selected"; } ?>><?php esc_html_e('Grid', 'slz');?></option>
		<option value="slider"<?php if( $template == 'slider' ) { echo " selected"; } ?>><?php esc_html_e('Slider', 'slz');?></option>
	</select>
</p>
<p>
