...
$options = array(
    'styling' => array(
        ...
        'desc'          => esc_html__( 'Change the style of footer', 'slz' ),
        'button'        => esc_html__( 'Styling', 'slz' ),
        'size'          => 'medium',
        'popup-options' => array(
            'bg-color'     => array(
                'label'   => esc_html__( 'Background Color', 'slz' ),
                'desc'    => esc_html__( "Select the footer's background color", "slz" ),
                'value'   => '',
            ...
            'text-color'      => array(
                ...
                'desc'    => esc_html__( 'Select footer\'s text color', 'slz' ),
                'value'   => '',
                'choices' => $palette_color,
                'type'    => 'color-palette'
            ),
				...
				'choices'      => array(
					'enable' => array(
								...
								'area-left-content' => array(
									...
									'options' => array(
										...
										'social-left' => array(
											...
											'desc'         => esc_html__( 'Select social in the "General" settings', 'slz' ),
											'left-choice'  => array(
												'value' => 'hide',
												'label' => esc_html__( 'Hide', 'slz' )
											),
										...
										'navigation-left' => array(
											...
											'desc'  => esc_html__('Please choose locations is "Bottom menu" in ','slz').' <br><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" >'.esc_html__('Appearance','slz').' > '.esc_html__('Menus','slz').'</a>',
											'type'         => 'switch',
											'right-choice' => array(
												'value' => 'show',
												'label' => esc_html__( 'Show', 'slz' )
						...
						'right-area-tab' => array(
							'type'          => 'tab',
							'title'         => esc_html__( 'Rigth Area Content', 'slz' ),
							'options' => array(
