	...
	public function render( $echo = true)
	{
		...
		if ( !empty ( $options ) ) {
            ...
            foreach ($area_arr as $key) {
            	...
            	$bg_color = slz_akg('footer-bottom/enable/btn-'.$key.'/show/custom/bg-color/color', $options, '');

            	$bg_hv_color = slz_akg('footer-bottom/enable/btn-'.$key.'/show/custom/bg-hv-color/color', $options, '');
            	$text_color = slz_akg('footer-bottom/enable/btn-'.$key.'/show/custom/text-color/color', $options, '');
            	
            	$text_hv_color = slz_akg('footer-bottom/enable/btn-'.$key.'/show/custom/text-hv-color/color', $options, '');
            	$bd_color = slz_akg('footer-bottom/enable/btn-'.$key.'/show/custom/border-color/color', $options, '');
            	$bd_hv_color = slz_akg('footer-bottom/enable/btn-'.$key.'/show/custom/border-hv-color/color', $options, '');
