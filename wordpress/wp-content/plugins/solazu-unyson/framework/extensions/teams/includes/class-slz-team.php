...
class SLZ_Team extends SLZ_Custom_Posttype_Model {
	...
	public function get_social_style2(){
	...
	public function set_default_options( $html_options = array() ) {
		$defaults = array(
			...
			'phone_format'			=> '<a href="%1$s" class="%2$s info-item"><span>'.esc_html('Email: ', 'slz').'</span>%3$s</a>',
			'email_format'			=> '<a href="%1$s" class="%2$s"><span>'.esc_html('Phone: ', 'slz').'</span>%3$s</a>',
			'info_format2'          => '<i class="%2$s">%1$s</i>',
			...
			'image_format'			=> '%1$s <a href="%2$s" tabindex="1" class="link"></a>',
