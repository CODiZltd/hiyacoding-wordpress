		...
		if( $this->query->have_posts() ) {
			while ( $this->query->have_posts() ) {
				...
				printf( $html_options['html_format'],
					...
					$this->get_title(),
					$this->get_btn_more( $html_options ),
							...
							<div class="modal-body">
								<div class="form-group">
									<div class="donation-button-segment-group slz-form-donate">
										<div class="radio">
											<label class="donate-item">
												<input type="radio" name="valueDonation" value="5" checked="true" />
												<span class="label-check slz-btn">'. slz_get_currency_format_options('5') .'</span>
											</label>
											<label class="donate-item">
												<input type="radio" name="valueDonation" value="10" />
												<span class="label-check slz-btn">'. slz_get_currency_format_options('10') .'</span>
											</label>
											<label class="donate-item">
												<input type="radio" name="valueDonation" value="15" />
												<span class="label-check slz-btn">'. slz_get_currency_format_options('15') .'</span>
											</label>
											<label class="donate-item">
												<input type="radio" name="valueDonation" value="20" />
												<span class="label-check slz-btn">'. slz_get_currency_format_options('20') .'</span>
											</label>
											<label class="donate-item">
