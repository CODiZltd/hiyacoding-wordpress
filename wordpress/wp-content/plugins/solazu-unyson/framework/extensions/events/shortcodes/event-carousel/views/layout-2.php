...
$html_format = '
	<div class="item" data-targetdate="%7$s">
            ...
            <div class="main-count-wrapper">
                <div class="main-count">
                    <div class="time days flip">
                        <span id="days-%6$s" class="count curr top"></span>
                    </div>
            ...
            <div class="main-count-wrapper">
                <div class="main-count">
                    <div class="time hours flip">
                        <span id="hours-%6$s" class="count curr top"></span>
                    </div>
                    <div class="count-height"></div>
            ...
            <div class="main-count-wrapper">
                <div class="main-count">
                    <div class="time minutes flip">
                        <span id="minutes-%6$s" class="count curr top"></span>
                    </div>
                    <div class="count-height"></div>
            ...
            <div class="main-count-wrapper">
                <div class="main-count">
                    <div class="time seconds flip">
                        <span id="seconds-%6$s" class="count curr top"></span>
                    </div>
                    <div class="count-height"></div>
