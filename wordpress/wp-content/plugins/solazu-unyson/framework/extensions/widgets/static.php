...
if (! is_admin()) {
	//css
	wp_enqueue_style(
			'slz-extension-widgets-styles',
			slz_ext('widgets')->get_uri('/static/css/widget-styles.css')
	);
	//js
// 	wp_enqueue_script(
// 			'slz-extension-widgets-scripts',
// 			slz_ext('widgets')->get_uri( '/static/js/scripts.js' ),
// 			array( 'jquery' ),
