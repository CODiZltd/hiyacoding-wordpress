...
?>
		<div class="slz-progress-bar-01 <?php echo esc_attr( $class ); ?>">
			...
			<div class="progress">
				<div role="progressbar" aria-valuenow="<?php echo esc_attr( $item['percent'] ); ?>" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-<?php echo esc_attr( $i ); ?>" data-unit="<?php echo esc_attr( $data['unit'] ); ?>">
					<span data-from="0" data-to="" data-speed="1200" class="percent progress-bar-percent-<?php echo esc_attr( $i ); ?>"></span>
				</div>
			</div>
		</div>
