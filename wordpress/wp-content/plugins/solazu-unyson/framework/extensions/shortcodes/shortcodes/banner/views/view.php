					...
					?>
						...
						?>
							<a href="<?php echo esc_url( $vc_link_arr['link'] ); ?>" <?php echo esc_attr( $vc_link_arr['target'] ); ?> <?php echo esc_attr( $vc_link_arr['url_title'] ); ?> class="slz-btn sc-banner-btn-<?php echo esc_attr( $i ); ?>">
								...
								?>
									<?php
										if( $data['icon_type_'.$i] != 'none' ) {
											if( !empty( $data['icon_fontawsome_'.$i] ) ) {
												echo '<span class="btn-icon '. esc_attr( $data['icon_fontawsome_'.$i] ) .'"></span>';
											}elseif ( $data['icon_flaticon_'.$i] ) {
												echo '<span class="btn-icon '. esc_attr( $data['icon_flaticon_'.$i] ) .'"></span>';
											}
										}
									?>
