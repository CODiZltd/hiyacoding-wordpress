            ...
            ?>
                ...
                <div class="blog-detail-wrapper">
                    ...
                    <div class="entry-content">
                        <?php
                            the_content( sprintf(
								esc_html__( 'Read more %s', 'seogrow' ),
                    ...
                    <footer class="entry-footer">
                        <?php edit_post_link( __( 'Edit', 'seogrow' ), '<span class="edit-link">', '</span>' ); ?>
                    </footer>
                </div>
                ...
                <div class="slz-post-footer">
                    ...
                    <div class="slz-related-post slz_single_relate_post">
                        ...
                        <div class="related-title"><?php echo esc_html__('Related Articles', 'seogrow'); ?></div>

                        <div class="slz-carousel-wrapper">
                        
                            <div class="carousel-overflow">
                                <div data-slidestoshow="1" class="slz-carousel">
                                    <?php
