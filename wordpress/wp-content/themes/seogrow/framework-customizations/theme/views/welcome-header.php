...
<div class="uns-featured-section">
	<h2 class="heading-title"><?php echo esc_html__('Welcome to', 'seogrow'); ?> <?php echo esc_html( slz()->theme->manifest->get('name') ); ?></h2>
	<div class="description">
		<?php echo esc_html( slz()->theme->manifest->get('description') ); ?>
		<div class="slz-notice">
			<p><?php echo esc_html__('Please kindly DO NOT update Unyson Plugin separately!', 'seogrow');?></p>
			<p><?php echo esc_html__('We had customized its coding structure and create it a our own unique technique, if you update it, it will turn your site into "Forbidden" state and let your site DOWN.', 'seogrow');?></p>
		</div>
	</div>
	<ul class="nav nav-tabs nav-justified">
		<li <?php echo ($page==slz()->theme->manifest->get('id') ? 'class="active"': '') ?>>
			<a href="<?php echo esc_url ( admin_url( 'admin.php?page=' . slz()->theme->manifest->get('id') ) ); ?>">
				<span><?php echo esc_html__('Plugins', 'seogrow'); ?></span>
			</a>
		</li>
		...
		<?php if ( slz()->extensions->_get_db_active_extensions('backups') ) : ?>
			<li>
				<a href="<?php echo esc_url ( admin_url( 'admin.php?page=' . slz_ext('backups')->get_page_slug() ) ); ?>">
					<span><?php echo esc_html__('Backup Data', 'seogrow'); ?></span>
				</a>
			</li>
		<?php endif; ?>
		<?php if ( slz()->extensions->_get_db_active_extensions('backups-demo') ) : ?>
			<li>
				<a href="<?php echo esc_url ( admin_url( 'admin.php?page=' . slz_ext('backups-demo')->get_page_slug() ) ); ?>">
					<span><?php echo esc_html__('Demo Install', 'seogrow'); ?></span>
				</a>
			</li>
		<?php endif; ?>
	</ul>
