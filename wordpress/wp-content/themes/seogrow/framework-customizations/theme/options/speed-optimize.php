...
if( SEOGROW_WC_ACTIVE ) {
	$woo_options = array(
		'reject_woo_page' => array(
			'type'  => 'checkboxes',
			'attr'  => array('class' => 'cache_modify_listener '),
			'label' => esc_html__('Rejected WooCommerce Pages', 'seogrow'),
			'desc'  => esc_html__('Do not cache the above pages.', 'seogrow'),
			'value' => array(
				'cart'     => true,
				'checkout' => true
			),
			'choices' => array(
				'account'  => esc_html__('My Account', 'seogrow'),
				'cart'     => esc_html__('Cart', 'seogrow'),
				'checkout' => esc_html__('Checkout', 'seogrow'),
				'shop'     => esc_html__('Shop', 'seogrow')
			)
		)
	);
				...
				'options' => array(
					'general_box'        => array(
						...
						'options' => array(
							...
							'clear_minify' => array(
								'type'        => 'slz-minify',
								'button_text' => esc_html__('Delete Minify Files', 'seogrow'),
					...
					'page_cache_general_box'        => array(
						...
						'options' => array(
							...
							'cache_compress_content' => array(
								...
								'desc'  => esc_html__('Compression is disabled by default because some hosts have problems with compressed files. Switching it on and off clears the cache.', 'seogrow'),
								'value' => false,
							),
