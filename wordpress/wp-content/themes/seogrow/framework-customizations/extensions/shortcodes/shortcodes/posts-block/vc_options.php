...
$block_title = array(
    array(
        'type'        => 'textfield',
        'heading'     => esc_html__( 'Block Title', 'seogrow' ),
        'param_name'  => 'block_title',
        'value'       => '',
        'description' => esc_html__( 'Block title. If it blank the block will not have a title', 'seogrow' )
    ),
    array(
        'type'        => 'colorpicker',
        'heading'     => esc_html__( 'Block Title Color', 'seogrow' ),
...
$layouts = array(
    array(
        'type'        => 'dropdown',
        'heading'     => esc_html__( 'Layouts', 'seogrow' ),
        'param_name'  => 'layout',
...
$params = array(
    array(
        'type'        => 'textfield',
        'heading'     => esc_html__( 'Number Posts', 'seogrow' ),
        'param_name'  => 'limit_post',
        'value'       => '5',
        'description' => esc_html__( 'The number of posts to display. If it blank the number posts will be the number from Settings -> Reading', 'seogrow' )
    ),
    array(
        'type'        => 'textfield',
        ...
        'value'       => '',
        'description' => esc_html__( 'Enter offset to display. If you want to start on record 6, using offset 5', 'seogrow' )
    ),
    array(
        'type'        => 'dropdown',
        ...
        'description' => esc_html__( 'Choose criteria to display.', 'seogrow' )
    ),
    array(
        'type'        => 'textfield',
        'heading'     => esc_html__( 'Excerpt Length', 'seogrow' ),
        'param_name'  => 'excerpt_length',
        'value'       => '15',
        'description' => esc_html__( 'Enter number of excerpt length', 'seogrow' )
    ),
    array(
        'type'        => 'textfield',
        'heading'     => esc_html__( 'Button "Read More" Text', 'seogrow' ),
        'param_name'  => 'btn_read_more',
        'value'       => esc_html__('Read More','seogrow'),
        'dependency'     => array(
            'element'  => 'layout',
            'value_not_equal_to' => array( 'layout-4' )
        ),
        'description' => esc_html__( 'Enter text for button "read more"', 'seogrow' )
    ),
    array(
        'type'        => 'textfield',
