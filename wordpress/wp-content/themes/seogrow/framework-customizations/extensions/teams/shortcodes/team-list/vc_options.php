...
$params = array(
	...
	array(
		...
		'value'         => '',
		'description'   => esc_html__( 'Choose color for button.', 'seogrow' ),
		'group'         => esc_html__('Custom', 'seogrow'),
		'dependency'    => array(
			'element'       => 'btn_content',
			'not_empty'         => true,
	...
	array(
		...
		'param_name'    => 'color_hv_button',
		'value'         => '',
		'description'   => esc_html__( 'Choose hover color for button.', 'seogrow' ),
		'group'         => esc_html__('Custom', 'seogrow'),
		'dependency'    => array(
			'element'       => 'btn_content',
			'not_empty'         => true,
