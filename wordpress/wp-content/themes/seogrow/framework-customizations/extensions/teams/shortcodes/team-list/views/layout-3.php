...
<div class="layout-3 slz-shortcode sc_team_list sc_team_carousel <?php echo esc_attr( $data['block_cls'] ); ?>" data-item="<?php echo esc_attr($data['uniq_id']); ?>">
	<?php
...
if ( !empty( $data['block_bg_color'] ) ) {
	$css = '
		.%1$s .slz-block-team-01{
			background-color: %2$s !important;
		}
		.%1$s .slz-block-team-01 .team-body{
			background-color: %2$s !important;
		}
	';
