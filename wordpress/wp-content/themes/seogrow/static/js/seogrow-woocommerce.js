    ...
    seoGrow.woocommerce = function() {
        ...
        $(window).load(function() {
            ...
            $(".quantity input").each(function() {
                $(this).before('<input type="button" value="-" class="minus button is-form">');
                $(this).after('<input type="button" value="+" class="plus button is-form">');
            });
