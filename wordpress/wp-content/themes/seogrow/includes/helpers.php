...
if ( ! function_exists( 'seogrow_get_container_class' ) ) :
	function seogrow_get_container_class( $template = '' ,$is_taxonomy = false ) {
...
if ( ! function_exists( 'seogrow_fonts_url' ) ) :
	...
	function seogrow_fonts_url( $fonts = array() ) {
		$fonts_url = '';
	...
	function seogrow_comment_form() {
        ...
        $author_field = sprintf(
            '<div class="comment-form-author">
						<input id="author" name="author" placeholder="Name *" type="text" value="%1$s" %2$s>
        ...
        $email_field = sprintf(
            '<div class="comment-form-email">
						<input  id="email" name="email" placeholder="Email Address *" %5$s value="%1$s" size="30" %2$s />
